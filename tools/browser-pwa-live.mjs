...
try{
 ...
 await ctx.setOffline(true);await page.goto(base+'?debug=1&seed=1');await page.locator('#btn-guide').click();assert.equal(await page.locator('.guide-card').count(),10);await page.locator('.guide-close').click();await page.locator('#btn-challenge').click();await page.waitForTimeout(3800);
