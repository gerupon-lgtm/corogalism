...
**採用決定:** 全項目C案。比較画像左下の葉マーク＋Corogalismロゴも採用。追加指示でトースト位置は盤面中央、TIME・HPもトイ調に統一。実装は `../../toy-visuals.md`。

以下は方向性を比較した時点のコンセプト記録。採用したC案と追加指示はv0.2.2に実装・公開済み。
...
- クリア時はゴール付近の短い演出と「クリア！／次の面へ」の操作付きトーストを同時に出す。演出の完了を待たずに次へ進める。
