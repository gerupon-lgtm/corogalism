...
browser-screen-fit:393×820/390×780/360×800/320×568。トップ・両モード、PAUSEガイドの時間／ボール維持・再開、画面縮小時の座標維持成功。browser-pause-touch:320×480の3ボタン構成でネイティブスワイプ成功。規約・仕様レビュー済み。公開結果は追記。
